...
public class SignupActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String styledText = "Already have an account? <font color='#518f2b'><b>login</b></font>";
        returnToLoginTextV.setText(Html.fromHtml(styledText), TextView.BufferType.SPANNABLE);
